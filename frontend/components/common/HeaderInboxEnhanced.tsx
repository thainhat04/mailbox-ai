      ...
      <div className="px-6 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3 shrink-0">
          ...
          <div className="hidden sm:flex flex-col">
            <h1 className="font-bold text-lg leading-tight">MailBox</h1>
          ...
          >
            ...
            >
              ...
              <div className="hidden xl:flex items-center gap-1 px-3 py-1 mr-2 bg-white/5 border border-white/10 rounded-lg">
                ...
                <kbd className="text-[10px] font-semibold text-white/50">K</kbd>
              </div>
            </div>
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs text-white/40 truncate">
                          {suggestion.type === SuggestionType.SENDER
                            ? "Sender"
                            : "Keyword"}
                        </p>
                      </div>
          ...
          >
            <div
              className={`flex items-center bg-white/5 border rounded-xl overflow-hidden transition-all duration-300 ${
                isFocused ? "border-cyan-400/50 bg-white/8" : "border-white/10"
              }`}
            >
              <button
                type="submit"
