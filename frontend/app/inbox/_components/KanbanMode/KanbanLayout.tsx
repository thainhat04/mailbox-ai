...
function KanbanLayout() {
    ...
    return (
        <div
            ...
            className="relative kanban__layout  w-full flex flex-col overflow-hidden text-white"
        >
            {/* Gradient background */}
            <div className="absolute inset-0 bg-linear-to-br from-[#0f111a] via-[#1a1b2b] to-[#2c1e4f] backdrop-blur-sm pointer-events-none" />
